          ...
          <div className="p-5 space-y-4">
            ...
            <div className="rounded-xl border border-white/5 bg-white/[0.02] p-3.5">
              ...
              <div className="space-y-2">
                {[
                  { name: "Rafiq's MacBook Air", icon: Laptop, ip: "192.168.4.12", speed: "32 Mbps", status: "Active" },
                  { name: "Galaxy S23 Ultra", icon: Smartphone, ip: "192.168.4.19", speed: "18 Mbps", status: "Active" },
                  { name: "Campus Lab Desktop", icon: Laptop, ip: "192.168.4.24", speed: "24 Mbps", status: "Active" },
                ].map((device, idx) => (
